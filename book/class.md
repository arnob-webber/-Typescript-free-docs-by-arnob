...
```typescript
const myObject = new Person('Sydney Sweeney', 25);
myObject.sayHi(); 
```
...
const sydney = new Person('Sydney', 26);
sydney.sayHello();
```
...
const p2 = new Person('Sydney Sweeney', 26, 'f');
```
...
const person2 = new Person('Sydney Sweeney');
person2.displayInfo(); 

const person3 = new Person('Ana de Armas', 35);
person3.displayInfo(); 
```
...
const person1 = new Person('Sydney Sweeney');
person1.introduce(); 
```
...
const person = new Person('Sydney Sweeney', 26);
person.introduce();
```
...
console.log(container1.getItem()); 

const container2 = new Container<string>('Hello');
container2.setItem('World');
console.log(container2.getItem()); 
```
